...
// Update 'What if 1% of the planet...' metrics
function updateGlobalWhatIfImpact() {
  document.getElementById("whatif-wind").textContent = "300";
  document.getElementById("whatif-ireland").textContent = "0.005×Ireland";
  document.getElementById("whatif-flight").textContent = "542";
}

// Call it on DOM load
document.addEventListener("DOMContentLoaded", function () {
  updateGlobalWhatIfImpact();
});
